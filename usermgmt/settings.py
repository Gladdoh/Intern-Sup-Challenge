...
# For development, if .env doesn't exist, try .env.example
...
SECRET_KEY = 'django-insecure-@u-zy_ryzmt&dqo43oi624gt&h6k1k$i#ufkl0whds8+f0nbqu'
...
SITE_DOMAIN = '127.0.0.1:8000'  # Using IP address for development
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.site_domain',
            ],
        },
    },
]
